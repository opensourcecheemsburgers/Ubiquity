...
use crate::player::rust::cpal::OutputStreamTimestamp;
use crate::player::rust::cpal::StreamInstant;
use crate::player::rust::cpal::traits::{DeviceTrait, HostTrait, StreamTrait};
use crate::player::rust::cpal::{
    BackendSpecificError, BufferSize, BuildStreamError, Data, DefaultStreamConfigError,
    DeviceNameError, DevicesError, HostUnavailable, InputCallbackInfo, OutputCallbackInfo, PauseStreamError,
            ...
            on_ended_closure
                ...
                .replace(Closure::wrap(Box::new(move || {
                    ...
                    // Populate the sample data into an interleaved temporary buffer.
                    {
                        ...
                        let playback = StreamInstant::from_secs_f64(time_at_start_of_buffer);
