...
macro_rules! impl_platform_host {
    ($($(#[cfg($feat: meta)])? $HostVariant:ident $host_mod:ident $host_name:literal),*) => {
        ...
        pub struct Stream(StreamInner, super::super::platform::NotSendSyncAcrossAllPlatforms);
        ...
        pub enum DeviceInner {
            $(
                $(#[cfg($feat)])?
                $HostVariant(super::super::host::$host_mod::Device),
            )*
        }
        ...
        pub enum DevicesInner {
            $(
                $(#[cfg($feat)])?
                $HostVariant(super::super::host::$host_mod::Devices),
            )*
        }
        ...
        pub enum HostInner {
            $(
                $(#[cfg($feat)])?
                $HostVariant(super::super::host::$host_mod::Host),
            )*
        }
        ...
        pub enum StreamInner {
            $(
                $(#[cfg($feat)])?
                $HostVariant(super::super::host::$host_mod::Stream),
            )*
        }
        ...
        enum SupportedInputConfigsInner {
            $(
                $(#[cfg($feat)])?
                $HostVariant(super::super::host::$host_mod::SupportedInputConfigs),
            )*
        }
        ...
        enum SupportedOutputConfigsInner {
            $(
                $(#[cfg($feat)])?
                $HostVariant(super::super::host::$host_mod::SupportedOutputConfigs),
            )*
        }
        ...
        impl Iterator for SupportedInputConfigs {
            type Item = super::super::SupportedStreamConfigRange;
        ...
        impl super::super::traits::DeviceTrait for Device {
            type SupportedInputConfigs = SupportedInputConfigs;
            type SupportedOutputConfigs = SupportedOutputConfigs;
            type Stream = Stream;

            fn name(&self) -> Result<String, super::super::DeviceNameError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
            ...
            fn supported_input_configs(&self) -> Result<Self::SupportedInputConfigs, super::super::SupportedStreamConfigsError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
            ...
            fn supported_output_configs(&self) -> Result<Self::SupportedOutputConfigs, super::super::SupportedStreamConfigsError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
                        DeviceInner::$HostVariant(ref d) => {
            ...
            fn default_input_config(&self) -> Result<super::super::SupportedStreamConfig, super::super::DefaultStreamConfigError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
            ...
            fn default_output_config(&self) -> Result<super::super::SupportedStreamConfig, super::super::DefaultStreamConfigError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
            ...
            fn build_input_stream_raw<D, E>(
                &self,
                config: &super::super::StreamConfig,
                sample_format: super::super::SampleFormat,
                data_callback: D,
                error_callback: E,
            ) -> Result<Self::Stream, super::super::BuildStreamError>
            where
                D: FnMut(&super::super::Data, &super::super::InputCallbackInfo) + Send + 'static,
                E: FnMut(super::super::StreamError) + Send + 'static,
            {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
            ...
            where
                D: FnMut(&mut super::super::Data, &super::super::OutputCallbackInfo) + Send + 'static,
                E: FnMut(super::super::StreamError) + Send + 'static,
            {
                match self.0 {
                    $(
        ...
        impl super::super::traits::HostTrait for Host {
            ...
            fn is_available() -> bool {
                $(
                    $(#[cfg($feat)])?
                    if super::super::host::$host_mod::Host::is_available() { return true; }
                )*
                false
            }

            fn devices(&self) -> Result<Self::Devices, super::super::DevicesError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
        ...
        impl super::super::traits::StreamTrait for Stream {
            fn play(&self) -> Result<(), super::super::PlayStreamError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
            ...
            fn pause(&self) -> Result<(), super::super::PauseStreamError> {
                match self.0 {
                    $(
                        $(#[cfg($feat)])?
                        StreamInner::$HostVariant(ref s) => {
        ...
        $(
            $(#[cfg($feat)])?
            impl From<super::super::host::$host_mod::Device> for Device {
                fn from(h: super::super::host::$host_mod::Device) -> Self {
                    DeviceInner::$HostVariant(h).into()
                }
            }

            $(#[cfg($feat)])?
            impl From<super::super::host::$host_mod::Devices> for Devices {
                fn from(h: super::super::host::$host_mod::Devices) -> Self {
                    DevicesInner::$HostVariant(h).into()
                }
            }

            $(#[cfg($feat)])?
            impl From<super::super::host::$host_mod::Host> for Host {
                fn from(h: super::super::host::$host_mod::Host) -> Self {
                    HostInner::$HostVariant(h).into()
                }
            }

            $(#[cfg($feat)])?
            impl From<super::super::host::$host_mod::Stream> for Stream {
                fn from(h: super::super::host::$host_mod::Stream) -> Self {
        ...
        pub fn available_hosts() -> Vec<HostId> {
            ...
            $(
                $(#[cfg($feat)])?
                if <super::super::host::$host_mod::Host as super::super::traits::HostTrait>::is_available() {
        ...
        pub fn host_from_id(id: HostId) -> Result<Host, super::super::HostUnavailable> {
            match id {
                $(
                    $(#[cfg($feat)])?
                    HostId::$HostVariant => {
                        super::super::host::$host_mod::Host::new()
...
// mod platform_impl {
//     pub use super::super::host::coreaudio::{
...
// mod platform_impl {
//     pub use super::super::host::emscripten::{
...
mod platform_impl {
    pub use super::super::host::wasmplayer::{
    ...
    impl_platform_host!(WebAudio wasmplayer "WebAudio");
...
//     };
//     pub use super::super::host::wasapi::{
