...
use crate::player::rust::Source;
use crate::player::rust::decoder;
use crate::player::rust::dynamic_mixer::{DynamicMixerController, mixer};
// use sink::Sink;
// use cpal::traits::{DeviceTrait, HostTrait, StreamTrait};
// use cpal::Sample;
use crate::player::rust::cpal::{
    default_host,
    Device,
    Stream,
    traits::{DeviceTrait, HostTrait, StreamTrait},
    BuildStreamError, ChannelCount, DefaultStreamConfigError, Devices, DevicesError,
...
pub trait CpalDeviceExt {
    ...
    ) -> Result<(Arc<DynamicMixerController<f32>>, Stream), BuildStreamError>;
...
impl CpalDeviceExt for Device {
    fn new_output_stream_with_format(
        ...
        let (mixer_tx, mut mixer_rx) =
            mixer::<f32>(format.channels(), format.sample_rate().0);
        ...
        match format.sample_format() {
            ...
            SampleFormat::I16 => self.build_output_stream::<i16, _, _>(
                &format.config(),
                move |data, _| {
                    data.iter_mut()
            ...
            SampleFormat::U16 => self.build_output_stream::<u16, _, _>(
                &format.config(),
                move |data, _| {
